...
#pragma shader_feature USE_DETAILNORMAL
		...
		inline void surf (Input IN, inout SurfaceOutputStandardSpecular o) {
			...
			o.Smoothness = 0;
			#else
			fixed4 Specular = _SpecularColor;
			o.Specular = 0;
			o.Smoothness = 0;
			#endif
			o.Albedo *= 1 - Specular.a;
			...
			screenUV.xy += o.Normal.xy * _Distortion;
			...
			#endif
			fixed4 ref = tex2Dproj(_ReflectionTex, screenUV);
			o.Emission = _EmissionColor + ref * Specular.rgb * Specular.a;
		}
